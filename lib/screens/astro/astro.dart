...
import 'package:astro/screens/panchang/panchang_screen.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class Astroui extends StatefulWidget {
  Astro? Astromodel;
  Astroui({this.Astromodel});

  @override
  _AstrouiState createState() => _AstrouiState();
}

class _AstrouiState extends State<Astroui> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(body: SingleChildScrollView(child:Container(height: 900,color: Colors.white,width: MediaQuery.of(context).size.width,child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
     ...
     /* Stack(children: [Column(children: [
      ...
      InkWell(onTap: (){Navigator.push(context, new MaterialPageRoute(builder: (__) => new panchangScreen()));},
        child: Container(padding: EdgeInsets.only(left: 26),child:Column(children: [SizedBox(height: 15,),

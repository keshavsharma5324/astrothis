...
import 'package:astro/screens/astro/astro.dart';
import 'package:astro/screens/astro/astro_cubit.dart';
import 'package:astro/screens/astro/astrofinal.dart';
import 'package:astro/screens/astro/astronew.dart';
...
class AstroScreen extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => AstroScreenState();
}

class AstroScreenState extends State<AstroScreen> {
  Astro? astro;
  Addres? addres;
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AstroCubit(repo: BaseRepo()),
      child: Scaffold(
        resizeToAvoidBottomInset: false,
       // key: _globalKey,
        body: BlocConsumer<AstroCubit, BaseState>(
            listener: (context, state) async {
              ...
              if (state is SuccessState) {
                ...
                astro = Astro.fromJson(state.response);
               /* FocusScope.of(context).requestFocus(FocusNode());
                _globalKey.currentState!.showSnackBar(getSnackBar(
                    astro!.httpStatus!, "OK", _globalKey));*/
                if(astro!.data==null){

...
class Astronew extends StatefulWidget {
  Astro? Astromodel;
  Astronew({this.Astromodel});

  @override
  _AstronewState createState() => _AstronewState();
}

class _AstronewState extends State<Astronew> {
  ...
  void initState() {
    ...
    day=currentDate.day;
    searchresults = widget.Astromodel!.data;
